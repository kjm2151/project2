...
d3.csv("Full Data_Lat_n_Lon.csv", function(err, Data) {
  if (err) throw err;
  ...
  // Scale the domain
  xLinearScale.domain([2, d3.max(Data, function(data) {
  ...
  var elemEnter =elem.enter()
      ...
      .attr("transform", function (data, index) {
        return "translate(" + xLinearScale(data.ratio_total) + " ," + yLinearScale(data.median_home_price) + ")"
      });
  ...
  chart.append("text")
      ...
      .attr("dy", "1em")
      .attr("class", "axisText")
      .text("Less Expensive <----------------> More Expensive");
